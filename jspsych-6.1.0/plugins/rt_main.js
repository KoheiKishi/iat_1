...
var category_block = {
  ...
  '<strong>同性愛</strong>:<br>' + "<img src='" + repo_site + "img/homohet/01_gay_symbol.jpg'></img>  " +
  "<img src='" + repo_site + "img/homohet/02_lesbian_symbol.jpg'></img>  " + "<img src='" + repo_site + "img/homohet/05_gay_doll.jpg'></img>  " +
  "<img src='" + repo_site + "img/homohet/06_lesbian_doll.jpg'></img>  " + '同性愛　同性愛者<br><br>' + 
  '<strong>異性愛</strong>:<br>' +
  "<img src='" + repo_site + "img/homohet/03_hetero_symbol.jpg'></img>  " + "<img src='" + repo_site + "img/homohet/04_hetero_symbol_mirror.jpg'></img>  " +
  "<img src='" + repo_site + "img/homohet/07_hetero_doll.jpg'></img>  " + "<img src='" + repo_site + "img/homohet/08_hetero_doll_mirror.jpg'></img>  " +
  '異性愛　異性愛者<br><br>' +
  "キーを押して，次に進んでください。</p>",
  post_trial_gap: 1000
};
...
var trial_block = {
  ...
  timeline_variables: [
    {type: 'iat-image', stimulus: repo_site + "img/homohet/01_gay_symbol.jpg", stim_key_association: "left"},
    {type: 'iat-image', stimulus: repo_site + "img/homohet/02_lesbian_symbol.jpg", stim_key_association: "left"},
    {type: 'iat-image', stimulus: repo_site + "img/homohet/05_gay_doll.jpg", stim_key_association: "left"},
    {type: 'iat-image', stimulus: repo_site + "img/homohet/06_lesbian_doll.jpg", stim_key_association: "left"},
    {type: 'iat-html', stimulus: "同性愛", stim_key_association: "left"},
    {type: 'iat-html', stimulus: "同性愛者", stim_key_association: "left"},
    {type: 'iat-image', stimulus: repo_site + "img/homohet/03_hetero_symbol.jpg", stim_key_association: "right"},
    {type: 'iat-image', stimulus: repo_site + "img/homohet/04_hetero_symbol_mirror.jpg", stim_key_association: "right"},
    {type: 'iat-image', stimulus: repo_site + "img/homohet/07_hetero_doll.jpg", stim_key_association: "right"},
    {type: 'iat-image', stimulus: repo_site + "img/homohet/08_hetero_doll_mirror.jpg", stim_key_association: "right"},
...
var instructions_block2 = {
  ...
  "間違えると赤いＸが現れます。" + 
  "<br>反対のキーを押して，次に進んでください。" + 
  "<br><br>準備ができたら，キーを押して始めてください。</div>",
};
...
var instructions_block3_1 = {
  ...
  "キーを押してください。<br>" + "「良い」または「異性愛」カテゴリーに属するターゲットが現れたら，<strong>I</strong>キーを押してください。<br>" +
  "すべてのターゲットは，どれか一つのカテゴリーに属します。<br><br>" + 
  "<br>間違えると赤いＸが現れます。反対のキーを押して，次に進んでください。" +
  "<br>できるだけ速く，かつ正確に回答してください。<br><br> " +
  "<br><br>準備が出来たら，キーを押して始めてください。</div>",
};
...
var instructions_block4 = {
  ...
  "<strong>悪い</strong><br><br>" + "<strong>同性愛</strong></p></div>" + "<div style='position: absolute; top: 18%; right: 20%'>" +
  "<p style='font-size:24pt'>I<br><br>" + "<strong>良い</strong><br><br>" + "<strong>異性愛</strong></p></div>" +
  "<div style='position: relative; top: 42%; margin-left: auto; margin-right: auto'>直前と同じ配置です。<br><br><br><br><br>" + 
  "間違えると赤いＸが現れます。<br>" + 
  "反対のキーを押して，次に進んでください。<br>" +
  "「悪い」または「同性愛」カテゴリーに属するターゲットが現れたら，<strong>E</strong>キーを押してください。<br>" +
  "「良い」または「異性愛」カテゴリーに属するターゲットが現れたら，<strong>I</strong>キーを押してください。<br>" +
  "すべてのターゲットは，どれか一つのカテゴリーに属します。<br><br>" +
  "できるだけ速く，かつ正確に回答してください。<br><br> " +
...
var trial_block5 = { 
    ...
    timeline_variables: [
      {type: 'iat-image', stimulus: repo_site + "img/homohet/01_gay_symbol.jpg", stim_key_association: "right"},
      {type: 'iat-image', stimulus: repo_site + "img/homohet/02_lesbian_symbol.jpg", stim_key_association: "right"},
      {type: 'iat-image', stimulus: repo_site + "img/homohet/05_gay_doll.jpg", stim_key_association: "right"},
      {type: 'iat-image', stimulus: repo_site + "img/homohet/06_lesbian_doll.jpg", stim_key_association: "right"},
      {type: 'iat-html', stimulus: "同性愛", stim_key_association: "right"},
      {type: 'iat-html', stimulus: "同性愛者", stim_key_association: "right"},
      {type: 'iat-image', stimulus: repo_site + "img/homohet/03_hetero_symbol.jpg", stim_key_association: "left"},
      {type: 'iat-image', stimulus: repo_site + "img/homohet/04_hetero_symbol_mirror.jpg", stim_key_association: "left"},
      {type: 'iat-image', stimulus: repo_site + "img/homohet/07_hetero_doll.jpg", stim_key_association: "left"},
      {type: 'iat-image', stimulus: repo_site + "img/homohet/08_hetero_doll_mirror.jpg", stim_key_association: "left"},
  ...
  var instructions_block6_1 = {
    ...
    "キーを押してください。<br>" + "「良い」または「同性愛」カテゴリーに属するターゲットが現れたら，<strong>I</strong>キーを押してください。<br>" +
    "<br>間違えると赤いＸが現れます。反対のキーを押して，次に進んでください。" +
    "<br>できるだけ速く，かつ正確に回答してください。<br><br> " +
    "<br><br>準備が出来たら，キーを押して始めてください。</div>",
  };
