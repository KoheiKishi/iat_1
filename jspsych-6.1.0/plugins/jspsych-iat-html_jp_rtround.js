 ...
 **/
 ...
 jsPsych.plugins['iat-html'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    html_str += "<div style='position: absolute; height: 20%; width: 100%; margin-left: auto; margin-right: auto; top: 42%; left: 0; right: 0'><p style='font-size:24pt' id='jspsych-iat-stim'>" + trial.stimulus + "</p></div>";

    html_str += "<div id='trial_left_align' style='position: absolute; top: 18%; left: 20%'>";

    if(trial.left_category_label.length == 1) {
      html_str += "<p style='font-size:24pt'>" + trial.left_category_key + "<br><br>" +
      trial.left_category_label[0].bold() + "</p></div>";
    } else {
      html_str += "<p style='font-size:24pt'>" + trial.left_category_key + "<br><br>" +
      trial.left_category_label[0].bold() + "<br>" + "<br>" +
    ...
    if(trial.right_category_label.length == 1) {
      html_str += "<p style='font-size:24pt'>" + trial.right_category_key + "<br><br>" +
      trial.right_category_label[0].bold() + '</p></div>';
    } else {
      html_str += "<p style='font-size:24pt'>" + trial.right_category_key + "<br><br>" +
      trial.right_category_label[0].bold() + "<br>" + "<br>" +
